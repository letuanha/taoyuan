<template>
  <div class="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4" @click.self="$emit('close')">
    <div class="game-panel w-full max-w-md text-center relative max-h-[80vh] flex flex-col">
      ...
      <Divider title class="my-4" label="Quản lý bản lưu" />
          ...
          <div v-if="info.exists" class="flex space-x-1 w-full">
            ...
            <div class="relative">
              ...
              >
                ...
                >
                  {{ uploading ? 'Đang tải lên...' : 'Tải lên đám mây' }}
                </Button>
                <Button
                  v-if="webdavReady"
                  :icon="CloudDownload"
                ...
                >
                  {{ downloading ? 'Đang tải xuống...' : 'Tải từ đám mây' }}
                </Button>
                <Button
      ...
      <template v-if="!Capacitor.isNativePlatform()">
        <Button :icon="Upload" class="text-center justify-center text-sm w-full" @click="triggerImport">Nhập bản lưu</Button>
