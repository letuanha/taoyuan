<template>
  <div>
    ...
    <p class="text-xs text-muted mb-3">消耗金属锭和铜钱升级工具，需等待2ngày。</p>
    ...
    <div v-if="inventoryStore.pendingUpgrade" class="border border-accent/30 rounded-xs px-3 py-2 mb-3 flex items-center justify-between">
      ...
      <span class="text-xs text-muted whitespace-nowrap ml-2">剩{{ inventoryStore.pendingUpgrade.daysRemaining }}ngày</span>
    </div>
